 ...
 * @param ncol O caractere a procurar.
 * */
 ...
 * Esta função conta o número de ocorrências de um caractere numa  \e string
 * Por exemplo, conta as ocorrências de 'a' em "anagrama" e devolve o nº de ocorrências.
 * @param mat O caractere a procurar.
 * @param nlin A  \e string onde onde as ocorrências do caractere serão contadas.
 * @param ncol A  \e string onde onde as ocorrências do caractere serão contadas.
 * */
 ...
 * @param s Um apontador para o endereço da variável coluna em memória
 * */
 ...
 * Por exemplo, conta as ocorrências de 'a' em "anagrama" e devolve o nº de ocorrências.
 * @param mat A matriz para preencher.
* @param x A  \e string onde onde as ocorrências do caractere serão contadas.
* @param y A  \e string onde onde as ocorrências do caractere serão contadas.
 * @param tipo A  \e string onde onde as ocorrências do caractere serão contadas.
* @param nlin O nº de linhas da matriz.
* @param ncol O nº de colunas da matriz.
 * @return O número de ocorrências do caractere, 0 caso não houver ocorrências do caractere na  \e string.
 * */
